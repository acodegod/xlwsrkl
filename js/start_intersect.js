    ...
    function init_intersect(){
        ...
        if(typeof(intersect_text)!='undefined' && intersect_text!=''){
            ...
            array_is_text=['亲爱的熊丽雯<br>十八岁生日快乐！是陪你过的第三个生日了，借你十八岁生日，求你平安喜乐，求你万事如意，求所有天命都偏爱你。三年都在一起，很多话都说过了。应该谢谢你给我安慰和包容。还有未来的期许。忱参未来的大律师，涂涵池未来的旅行伙伴。<br>我没有花店，却又实在想念。我只能给你我微不足道的一切，这样普通的爱。<br>生日快乐亲爱的。<br>你的池池和丞丞'];
            // array_str_temp=[];
